...
\newcommand{\miTitulo}{Criptosistemas basados en el problema de la mochila\xspace}	% jjj
...
\setbibpreamble{Las referencias sse listan por orden alfabético. Aquellas referencias con más de un autor están ordenadas de acuerdo con el primer autor.\par\bigskip}
