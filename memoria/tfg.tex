...
\newcommand{\miTitulo}{Polinomios Ortogonales y \\ Procesos de Nacimiento y Muerte. \\ Implementación en Python\xspace}
\newcommand{\miNombre}{José Luis Ruiz Benito\xspace}
...
\newcommand{\miTutor}{
  Teresa E. Pérez Fernández \\ \emph{Departamento de Matemática Aplicada} 

  % Añadir tantos tutores como sea necesario. 

  \medskip
  Francisco Luque Sánchez \\ \emph{Departamento de Ciencias de la \\ Computación e Inteligencia Artificial}
}
...
\part{Polinomios Ortogonales y \\ Procesos de Nacimiento y Muerte} % Dividir un libro en partes OPCIONAL
\cleardoublepage    
\input{capitulos/matematicas/polinomios_ortogonales}
\input{capitulos/matematicas/variable_discreta}
\input{capitulos/matematicas/procesos}

\cleardoublepage\part{Implementación de una biblioteca de Polinomios Ortogonales de Variable Discreta en Python}
\input{capitulos/informatica/analisis}
\input{capitulos/informatica/solucion}
\input{capitulos/informatica/demostracion}
